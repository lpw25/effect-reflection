...
\reify{\Sigma}{\loc_1}{\perform{\loc_1}{op}{v}} &\reducestoc \return{\indintro{\Sigma}{op}{v}{\abs{x}{\glob \tau_a}{\return{x}}}} \\
\reify{\Sigma}{\loc_1}{\perform{\loc_2}{op}{v}} &\reducestoc \perform{\loc_2}{op}{v} \qquad (\loc_1 \neq \loc_2) \\
...
\label{lemma:subject-reduction}
  \begin{equation*}
    ...
    \quad \wedge \quad v_1 \reducestov v_2 \quad \implies \quad \Gamma \turnv v_2 \types \tau
  \end{equation*}
\end{lemma}
...
local and global var rules, which are distinguished by how the variable
is bound in the context. Since none of the left-hand sides of our
reduction rules is a variable, there is always only a single typing rule
