...
\reify{\Sigma}{\loc_1}{\perform{\loc_1}{op}{v}} &\reducestoc \return{\indintro{\Sigma}{op}{v}{\abs{x}{\glob \tau}{\return{x}}}} \\
\reify{\Sigma}{\loc_1}{\perform{\loc_2}{op}{v}} &\reducestoc \perform{\loc_2}{op}{v} \qquad (\loc_1 \neq \loc_2) \\
\reify{\Sigma}{\loc_1}{\letv{x}{\perform{\loc_1}{op}{v}{c}}} &\reducestoc \return{\indintro{\Sigma}{op}{v}{\abs{x}{\glob \tau}{\reify{\Sigma}{\loc_1}{c}}}} \\
...
\label{lemma:yoneda-weakening}
  ...
  \end{align*}
\end{lemma}
The proof of these follows by mutual induction on the value and
...
\ref{lemma:local-cdiv} to reuse those premises with the weakened
context.
...
We will need two lemmas demonstrating that substitution preserves
typing, one for local bindings and one for global bindings.
\begin{lemma}
\label{lemma:local-substitution}
  \begin{align*}
    &\Gamma \turnv v_1 \types \tau_1
    \quad \wedge \quad \lbind{\Gamma}{x}{\tau_1} \turnv v_2 \types \tau_2
    \quad \implies \quad \Gamma \turnv \sbst{v_2}{x}{v_1} \types \tau_2 \\
    &\Gamma \turnv v \types \tau_1
    \quad \wedge \quad \lbind{\Gamma}{x}{\tau_1} \turnc c \types \tau_2
...
\label{lemma:global-substitution}
  \begin{align*}
    &\cdiv{\Gamma} \turnv v_1 \types \tau_1
    \quad \wedge \quad \gbind{\Gamma}{x}{\tau_1} \turnv v_2 \types \tau_2
    \quad \implies \quad \Gamma \turnv \sbst{v_2}{x}{v_1} \types \tau_2 \\
    &\cdiv{\Gamma} \turnv v \types \tau_1
    \quad \wedge \quad \gbind{\Gamma}{x}{\tau_1} \turnc c \types \tau_2
    \quad \implies \quad \Gamma \turnv \sbst{c}{x}{v} \types \tau_2
  \end{align*}
\end{lemma}
