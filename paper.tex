...
{\Gamma \turnv \indelimm{v_s}{\indretcase{x_r}{v_r} \seq
...
\indelimm{(\ret{v_s})}{\indretcase{x}{v_r} \seq \ldots} &\stepstov \sbst{v_r}{x}{v_s} \\
...
\and
\inferrule{v_p \parastepstov v_p^{\prime} \\ v_k \parastepstov v_k^{\prime} \\ v_r \parastepstov v_r^{\prime} \\ \overline{v_j \parastepstov v_j^{\prime}}}
{\indelimm{\indintro{op_i}{v_p}{v_k}}{\indretcase{x_r}{v_r} \seq
  ...
  \sbst{\sbst{v_i^{\prime}}{x_{p_i}}{v_p^{\prime}}}{x_{k_i}}{\abs{x_a}{\letv{x_w}{\app{v_k^{\prime}}{x_a}}{
     \return{(\indelimm{x_w}{\indretcase{x_r}{v_r^{\prime}} \seq
...
CR3 in Girad et al.\cite{??}.

Reducible values and computations are strongly normalizing:
\begin{lemma}
\label{lemma:red-implies-sn}
\begin{align*}
  &\redva{\Delta}{\tau}{\alpha} \subseteq \snv \\
  &\redca{\Delta}{\tau}{\alpha} \subseteq \snc
\end{align*}
\end{lemma}
\begin{proof}
...
Reduciblity predicates are compatible with reductions:
\begin{lemma}
\label{lemma:red-reduces}
\begin{align*}
  &v_1 \in \redva{\Delta}{\tau}{\alpha} \wedge v_1 \reducestov v_2 \implies v_2 \in \redva{\Delta}{\tau}{\alpha} \\
  &c_1 \in \redva{\Delta}{\tau}{\alpha} \wedge c_1 \reducestoc c_2 \implies c_2 \in \redva{\Delta}{\tau}{\alpha}
\end{align*}
\end{lemma}
\begin{proof}
...
\item[$\tau_1 \times \tau_2$:] By congruence we have
  ...
  $\fst{v_2} \in \redva{\Delta}{\tau_1}{\alpha}$ and
  $\snd{v_2} \in \redva{\Delta}{\tau_2}{\alpha}$ follow by the induction
  hypothesis.
