...
\newcommand{\reducestostlc}{\rightsquigarrow_{STLC}}
\newcommand{\reducesnotv}{\not\rightsquigarrow_{V}}
\newcommand{\reducesnotstlc}{\not\rightsquigarrow_{STLC}}
...
\begin{align*}
  ...
  \mathrm{values}, v :=\;& x \mid \abs{x}{\tau}{c}
...
{\Gamma \turnv \abs{x}{\tau_1}{c} \types \tau_1 \arr \tau_2}
\and
...
\begin{align*}
    ...
    &\qquad (\case{v}{x_1}{\abs{()}{1}{c_1}}{x_2}{\abs{()}{1}{c_2}}) \; ()
\end{align*}
...
also has a constructor $\ret{\Sigma}{v}$ where $v \gtypes \tau$.
...
\begin{example}
  ...
  \begin{align*}
    &\indintro{\Sigma_{bs}}{get}{()}{\\
      &\quad\abs{(\gbox{x_a})}{\glob (1 + 1)}{\\
          &\qquad \indintro{\Sigma_{bs}}{set}{\grun{\app{\mathit{negate}}{x_a}}}
            {\abs{(\gbox{x_r})}{\glob 1}{\ret{\Sigma_{bs}}{x_r}}}}}
  \end{align*}
...
$\yoneda{\Sigma} \arr \glob \tau$ into terms
...
\begin{align*}
  ...
  \mathrm{computations}, c :=\;& \ldots \perform{v}{op}{v} \mid \reify{\Sigma}{\loc}{c}
\end{align*}
\begin{mathpar}
\inferrule{\\}
...
{\Gamma \turnc \; \reify{\Sigma}{\loc}{c} \types \ind{\Sigma}(\tau)}
\end{mathpar}
...
\indelimm{\Sigma}{(\indintro{\Sigma}{op}{v_1}{v_2})}{H_1 \seq \indcase{op}{x_1}{x_2}{v_3} \seq H_2} &\reducestov \\
  \sbst{\sbst{v_3}{x_1}{v_1}}{x_2}{\abs{x_a}{\glob \tau_a}{\letv{x_w}{\app{v_2}{x_a}&}{\return{(\indelimm{\Sigma}{x_w}{H_1 \seq \indcase{op}{x_1}{x_2}{v_3} \seq H_2})}}}} \\
...
\perform{(\outl{v_1})}{op}{v_2} &\reducestoc \perform{v_1}{\mathrm{left}(op)}{v_2} \\
\perform{(\outr{v_1})}{op}{v_2} &\reducestoc \perform{v_1}{\mathrm{right}(op)}{v_2} \\
\reify{\Sigma}{\loc}{\return{(\gbox{v})}} &\reducestoc \return{\ret{\Sigma}{v}} \\
\reify{\Sigma}{\loc_1}{\perform{\loc_1}{op}{v}} &\reducestoc \return{\indintro{\Sigma}{op}{v}{\abs{(\gbox{x})}{\glob \tau_a}{\return{\ret{\Sigma}{x}}}}} \\
\reify{\Sigma}{\loc_1}{\letv{x}{\perform{\loc_1}{op}{v}}{c}} &\reducestoc \return{\indintro{\Sigma}{op}{v}{\abs{x}{\glob \tau_a}{\reify{\Sigma}{\loc_1}{c}}}} \\
\reify{\Sigma}{\loc_1}{\perform{\loc_2}{op}{v}} &\reducestoc \letv{(\gbox{x})}{\perform{\loc_2}{op}{v}}{\return{\ret{\Sigma}{x}}} \qquad (\loc_1 \neq \loc_2) \\
\reify{\Sigma}{\loc_1}{\letv{x}{\perform{\loc_2}{op}{v}}{c}} &\reducestoc \letv{x}{\perform{\loc_2}{op}{v}}{\reify{\Sigma}{\loc_1}{c}} \qquad (\loc_1 \neq \loc_2)
\end{align*}
...
\begin{align*}
  ...
  \mathrm{neutral\ atomic\ computations}, \nu :=\;& \app{\eta}{\omega}
                                            \mid \reify{\Sigma}{x}{\mu} \mid \perform{\eta}{op}{\omega} \\
  \mathrm{normal\ atomic\ computations}, \delta :=\;& \nu \mid \perform{\loc}{op}{\omega} \\
  \mathrm{neutral\ computations}, \mu :=\;& \nu \mid \letv{x}{\nu}{\gamma} \\
  \mathrm{normal\ computations}, \gamma :=\;& \mu \mid \return{\omega}
                                              \mid \letv{x}{\delta}{\gamma}
\end{align*}
...
\label{lemma:subject-reduction}
  \begin{align*}
    &\Gamma \turnv v_1 \types \tau
      \quad \wedge \quad v_1 \reducestov v_2
      \quad \implies \quad \Gamma \turnv v_2 \types \tau \\
    &\Gamma \turnc c_1 \types \tau
      \quad \wedge \quad c_1 \reducestoc c_2
...
We start by proving some general lemmas that we'll need in the various
proofs. Note that we will refer to a property that applies to both value
and computation terms, and which must be shown by mutual induction, as a
single lemma.

\subsubsection{Context division lemmas}
...
\subsubsection{Weakening lemmas}
...
compositional, the congruence cases also all follow directly by
...
\subsubsection{Effect reflection}

The cases for all the rules relating to effects and effect reflection:
\begin{align*}
\perform{(\outl{v_1})}{op}{v_2} &\reducestoc \perform{v_1}{\mathrm{left}(op)}{v_2} \\
\perform{(\outr{v_1})}{op}{v_2} &\reducestoc \perform{v_1}{\mathrm{right}(op)}{v_2} \\
\reify{\Sigma}{\loc}{\return{(\gbox{v})}} &\reducestoc \return{\ret{\Sigma}{v}} \\
...
\begin{aligned}[c]
  ...
  &\embed{\abs{x}{A}{e}} =
    \abs{(\gbox{x})}{\glob \embed{A}}{\return{\embed{e}}} \\
...
\begin{equation*}
  \embed{\app{(\abs{x}{A}{e_1})}{e_2}} \reducestov \embed{\sbst{e_1}{x}{e_2}}
\end{equation*}
which reduces to:
\begin{equation*}
\grun{\app{(\abs{(\gbox{x})}{\glob \embed{A}}{\return{\embed{e_1}}})}{\embed{e_2}}}  \reducestov \embed{\sbst{e_1}{x}{e_2}}
\end{equation*}
...
\label{lemma:stlc-reduces}
  \begin{equation*}
    e \reducesnotstlc
    \quad \implies \quad \embed{e} \reducesnotv
  \end{equation*}
\end{lemma}
